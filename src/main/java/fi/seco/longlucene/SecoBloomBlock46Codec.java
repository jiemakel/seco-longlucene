 ...
 * 
 */
public class SecoBloomBlock46Codec extends Codec {

	private final PostingsFormat postingsFormat = new BloomFilteringPostingsFormat(new Lucene41PostingsFormat());
	...
	public SecoBloomBlock46Codec() {
		super("SecoBloomBlock46");
	}
